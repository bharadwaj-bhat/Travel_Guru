...
const Md1=styled.div`
 ...
 border: 1px solid #a3a3a3 ;
 background-color: #fff;
border-bottom:${(props)=>(props.value)?"2px solid black" : "1px solid #a3a3a3"} ;
...
return <>
     <MainDiv onClick={handleColor1}>
       <SubDiv>
          <LefSide>
          <div><img src={process.env.PUBLIC_URL + "/read.png"} alt="" /></div>
          <LeftDivTop>
            <LeftPic>
                <img src="https://imgcld.yatra.com/ytimages/image/upload/t_hotel_yatra_details_desktop/v1511414418/Hotel/00096502/13-Deluxe_Room_mpSdTs.jpg" alt=""/>
            </LeftPic>
            <RightDetail>
              <RightP>The Verda Driftwood</RightP>
             <RightP1>Shey Yokma, Near Shey Church, Ladakh, Village Shey, Leh, 194101, India</RightP1>
              <MidRight>
                  <Check>
                       <p>Check-In</p>
                       <h1>29</h1>
                  ...
                  <MiddleLastDiv>
                      ...
                      <div style={{color:"#4197CD",cursor:"pointer"}}>Change Room</div>
                      </div>
                      <DetailDiv>
                          <div>Room 1:</div>
                          <div>1 Adult</div>
           ...
           <div><img src={process.env.PUBLIC_URL + "/travel.png"} alt="" /></div>
           <MiddleDiv>
               <Mdiv>
               ...
               <Instruction>Your booking details will be sent to this email address and mobile number.</Instruction>
        ...
        />
              ...
              <Instruction1>Special request can't be guaranteed. We will pass these requests to the hotels.</Instruction1>

           </MiddleDiv>
            <Continue>
            <Button variant="contained" color="secondary" disableElevation style={{backgroundColor:"green",width:"100%"}}>
      CONTINUE
    </Button>
          ...
          <RightSide>
            ...
            <input type="text" placeholder="Apply Promo Code"/>
             <Button variant="contained" color="default" disableElevation style={{backgroundColor:"#DDDDDD",width:"100%"}}>Apply</Button>
